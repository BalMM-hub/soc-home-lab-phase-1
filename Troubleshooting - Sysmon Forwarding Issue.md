...
![EventCode breakdown](figure24_eventcode_breakdown.png)
...
![inputs.conf fixed](figure25_inputs_fixed.png)
*Corrected inputs.conf file with the typo fixed*

![Forwarder restarted after fix](figure26_forwarder_restart_fixed.png)
