...
![Downloading Sysmon](images/figure18_sysmon_download.png)
*Downloading Sysmon from Microsoft Sysinternals*

![SwiftOnSecurity config](images/figure19_sysmon_config.png)
...
![inputs.conf updated](images/figure20_inputs_conf.png)
*inputs.conf updated with the Sysmon Operational log input*

![Forwarder restarted](images/figure21_forwarder_restart.png)
...
![Sysmon event in Event Viewer](images/figure22_event_viewer.png)
*Sysmon Event ID 11 (FileCreate) confirmed in Windows Event Viewer*

![Splunk search by host](images/figure23_splunk_host_search.png)
